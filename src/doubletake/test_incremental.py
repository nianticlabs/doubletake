...
def main(opts):
    ...
    assert opts.run_fusion, "Fusion must be run in incremental mode."
            ...
            for batch_ind, batch in enumerate(tqdm(dataloader)):
                ...
                if batch_ind * opts.batch_size > 0:
                    ...
                    if opts.depth_fuser == "ours":
                        ...
                        # set weights
                        sampled_weights_b1hw = sampled_weights_N.view(
                            1, 1, render_height, render_width
                        )
                ...
                if opts.run_fusion:
                    ...
                    if opts.depth_fuser == "custom_open3d":
                        fuser.fuse_frames(
