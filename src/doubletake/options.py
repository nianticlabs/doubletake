...
class Options:
    ...
    fusion_max_depth: float = 3.5
    # tsdf resolution for fusion
    fusion_resolution: float = 0.02
    ...
    # for the custom open3d fuser, trim voxels based on confidence when exporting a mesh
    trim_tsdf_using_confience: bool = False
